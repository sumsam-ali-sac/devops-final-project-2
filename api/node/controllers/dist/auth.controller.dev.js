...
var signup = function signup(req, res, next) {
  var _req$body, username, email, password, registeredStatus, userRole, hashedPassword, newUser;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          console.log("hello");
          _req$body = req.body, username = _req$body.username, email = _req$body.email, password = _req$body.password, registeredStatus = _req$body.registeredStatus, userRole = _req$body.userRole;
          _context.prev = 3;
          _context.next = 6;
...
var google = function google(req, res, next) {
  var user, _user$_doc, pass, rest, token, generatedPassword, hashedPassword, newUser, _token, _newUser$_doc, _pass, _rest;
